...
const SlackReactionListWithContext = React.memo(
  (props) => {
    ...
    console.log('openReactionPicker in slack reaction list', openReactionPicker)
    console.log('ownReactionTypes in slack reaction list', ownReactionTypes)
...
export const SlackReactionList = (props) => {
  ...
  const { ownReactionTypes, reactionCounts, reactionsByType, toggleReaction } =
    ...
    console.log(message.cid, 'message in slack reaction list')
    console.log(ownReactionTypes, 'ownReactionTypes in slack reaction list in slack reaction list')
